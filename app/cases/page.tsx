...
const BODY = `<section class="inner-hero">
  ...
  <section class="section" style="padding-top:20px;">
    ...
    <div class="cases-grid">
      ...
      <!-- 3. MODUL51 — live iframe (deployed on containers-web.vercel.app) -->
      ...
      <!-- 4. AVTOSCHOOL — placeholder -->
      <a class="case-card animate delay-3" data-category="app" href="/cases/avtoschool.html">
        <div class="case-cover placeholder-preview" style="background:linear-gradient(135deg,#dc2626,#f59e0b,#fde047)">
          <div class="placeholder-title">avtoschool.by</div>
        </div>
        <div class="case-body">
          <div class="case-meta">
      ...
      <a class="case-card animate is-extra" data-category="bot" href="/cases/usdt-exchange-bot.html">
